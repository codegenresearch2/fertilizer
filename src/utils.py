...
For the `url_join` function, I have ensured that the indentation and spacing are consistent with the gold code. I have also double-checked that all string literals are using double quotes as specified in the gold code.
