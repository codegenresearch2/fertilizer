...
def generate_new_torrent_from_file(
    ...
    try:
        ...
        raise TorrentDecodingError("Error decoding torrent file") from e
    except UnknownTrackerError as e:
        raise UnknownTrackerError("Torrent not from OPS or RED based on source or announce URL") from e
    except Exception as e:
        raise Exception(f"An unknown error occurred: {str(e)}") from e

    raise Exception("An unknown error occurred in the API response")
