...
# Add new source flags for OpsTracker
OpsTracker.source_flags_for_search = lambda: [b'OPS', b'ALT_OPS']
OpsTracker.source_flags_for_creation = lambda: [b'OPS', b'ALT_OPS']
