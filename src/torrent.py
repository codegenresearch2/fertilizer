...
def __generate_torrent_output_filepath(api_response: dict, source_name: str, output_directory: str, tracker_name: str) -> str:
  """
  ...
  Args:
    ...
    output_directory (str): The directory to save the new torrent file.
    tracker_name (str): The name of the tracker for the new torrent file.
