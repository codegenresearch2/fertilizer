...
In the rewritten code, I have added specific error handling for torrents and made sure to maintain code readability and structure. I have also made sure to maintain consistent test structure and naming while using `scan_torrent_file` instead of `scan_torrent_directory`. I have also moved the `__collect_infohashes_from_files` function outside of `scan_torrent_directory` and renamed it to `collect_infohashes_from_files` for consistency.