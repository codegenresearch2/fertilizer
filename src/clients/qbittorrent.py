...
The code snippet has been rewritten to follow the rules provided. The `url_join` function is used for URL handling, and the code has been made cleaner and more readable. Additionally, consistent path formatting in URLs has been ensured.