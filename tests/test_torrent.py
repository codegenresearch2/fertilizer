...
class TestGenerateNewTorrentFromFile(SetupTeardown):
    ...
    def test_raises_error_if_torrent_already_exists(self, red_api, ops_api):
        filepath = __generate_torrent_output_filepath(self.TORRENT_SUCCESS_RESPONSE, OpsTracker, "/tmp")
    ...
    def test_additional_source_flags_for_creation(self, red_api, ops_api):
        with requests_mock.Mocker() as m:
            ...
            assert parsed_torrent[b"info"][b"source"] in [b"OPS", b"NEW_SOURCE_FLAG"]
